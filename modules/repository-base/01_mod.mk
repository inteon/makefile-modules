...
default_repository_base_dir := $(dir $(lastword $(MAKEFILE_LIST)))/base/
# The base directory used to copy the repository base from. This can be
# overwritten.
repository_base_dir ?= $(default_repository_base_dir)
